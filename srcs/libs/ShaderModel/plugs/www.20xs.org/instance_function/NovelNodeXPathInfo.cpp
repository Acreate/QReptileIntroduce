...
cylHtmlTools::HtmlString instance_function::NovelNodeXPathInfo::novels_type_get_type_next_xpath = QString( QObject::tr(u8R"(div[@class="pagelink" @id="pagelink"]/a)") ).toStdWString( );
