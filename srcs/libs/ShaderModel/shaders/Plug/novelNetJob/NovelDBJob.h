...
public:
	...
	static interfacePlugsType::Vector_INovelInfoSPtr_Shared sort( const interfacePlugsType::Vector_INovelInfoSPtr_Shared &infos );
	/// <summary>
	/// 剔除相同
	/// </summary>
	/// <param name="infos"></param>
	/// <returns></returns>
	static interfacePlugsType::Vector_INovelInfoSPtr_Shared identical( const interfacePlugsType::Vector_INovelInfoSPtr_Shared &infos );
	/// <summary>
	/// 写入数据库
	/// </summary>
	...
	/// <param name="run">线程工作当中时，会调用该函数</param>
	/// <returns>写入个数</returns>
	static interfacePlugsType::Vector_INovelInfoSPtr_Shared readDb( OStream *thisOStream, const QString &outPath, const QUrl &url,  const std::function< bool( const std::chrono::system_clock::time_point::duration & ) > &run );
	/// <summary>
	/// 写入小说列表
	/// </summary>
	...
	static interfacePlugsType::Vector_INovelInfoSPtr_Shared writeFile( const QString &writeFilePath, const interfacePlugsType::Vector_INovelInfoSPtr_Shared &infos );
};
